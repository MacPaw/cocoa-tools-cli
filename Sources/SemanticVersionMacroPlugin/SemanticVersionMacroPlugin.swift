...
public struct SemanticVersionMacro: ExpressionMacro {
  ...
  public static func expand(version: SemanticVersion) -> ExprSyntax { .init(stringLiteral: version.codeExpression) }
}

@main
struct SemanticVersionMacroPlugin: CompilerPlugin {
  var providingMacros: [any Macro.Type] = [SemanticVersionMacro.self]
}
