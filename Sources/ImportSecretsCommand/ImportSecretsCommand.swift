...
extension ImportSecretsCommand {
  ...
  private func exportDestination(options: Options) throws -> ExportSecretsDestinationProtocol {
...
extension ImportSecretsCommand: AsyncParsableCommand {
  ...
  public mutating func run() async throws {
    ...
    let destination: ExportSecretsDestinationProtocol = try exportDestination(options: options)

    if let destination = destination as? ExportSecretsAsyncDestinationProtocol {
