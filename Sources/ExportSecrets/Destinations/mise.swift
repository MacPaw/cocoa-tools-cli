...
extension ExportSecrets.Destinations {
  ...
  public struct Mise {
    ...
    let miseCLI: any SecretsDestinationMiseProtocol
    ...
    public init(file: String? = "mise.local.toml", miseCLI: any SecretsDestinationMiseProtocol) {
      self.file = file
...
extension Mise: ExportSecretsDestinationProtocol {
  ...
  public init(file: String? = .none) throws {
    let miseCLI: any SecretsDestinationMiseProtocol = try Shell.Mise()
