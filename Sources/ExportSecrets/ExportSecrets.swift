...
extension ExportSecrets {
  ...
  public static func export(secrets: [String: String], destination: ExportSecretsAsyncDestinationProtocol) async throws
  {
  ...
  /// - Throws: Error.noSecretsToExport if no secrets are provided, or export errors from the destination.
  public static func export(secrets: [String: String], destination: ExportSecretsDestinationProtocol) throws {
    guard !secrets.isEmpty else { throw Error.noSecretsToExport }
