...
@main
struct SemanticVersionBuildToolPlugin: BuildToolPlugin {
...
extension SemanticVersionBuildToolPlugin {
  func createBuildCommands(
    ...
    let outputFile = outputDirectory.appending(path: "\(targetName)Version.swift", directoryHint: .notDirectory)
